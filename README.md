...
## Project Overview 
This project is a detailed analysis of a multi-year sales dataset (totaling $2.29 Million across 5,009 transactions).

## The Problem 
The goal was to use data to focus on identifying which product categories and regions offer the biggest potential for profit improvement
Methodology & Visuals
...
•	The West and East Regions are the clear revenue drivers

•	With around $725K in sales, the West area leads, closely followed by the East. The South region, on the other hand, generates the least amount of revenue ($501K), suggesting that market intervention is necessary. 

•	Technology generates the highest total sales (about $836k), followed by Furniture. These are our growth engines
